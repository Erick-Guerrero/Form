        ...
        <form onSubmit={handleSubmit}>
          <div className={style.formGrid}>
            <div className="shadow-lg p-4 rounded-xl">
              <h2 className="text-green-400 mb-2 bg-green-950 rounded-3xl text-center p-3 font-semibold">
            ...
            <div className="shadow-lg p-4 rounded-xl">
            <h2 className='text-green-400 mb-2 bg-green-950 rounded-3xl text-center p-3 font-semibold'>Datos administrativos</h2>
              <div className={style.contenedorInput}>
            ...
            <div className="shadow-lg p-4 rounded-xl">
            <h2 className='text-green-400 mb-2 bg-green-950 rounded-3xl text-center p-3 font-semibold'>Dirección</h2>
              <div className={style.contenedorInput}>
            ...
            <div className="shadow-lg p-4 rounded-xl">
            <h2 className='text-green-400 mb-2 bg-green-950 rounded-3xl text-center p-3 font-semibold'>Porcentajes de las comisiones</h2>
            ...
            <div className="shadow-lg p-4 rounded-xl">
            <h2 className='text-green-400 mb-2 bg-green-950 rounded-3xl text-center p-3 font-semibold'>Premios</h2>
              <div className={style.customInput}>
